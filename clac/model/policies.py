...
class CLACPolicy(BasePolicy):
    """
    Policy class (with both actor and critic) for CLAC.
    ...
    def __init__(
        ...
        super(CLACPolicy, self).__init__(
            observation_space,
            action_space,
...
MlpPolicy = CLACPolicy


class CnnPolicy(CLACPolicy):
    """
    Policy class (with both actor and critic) for CLAC.
...
class MultiInputPolicy(CLACPolicy):
    """
    Policy class (with both actor and critic) for CLAC.
    ...
    def __init__(
        ...
        use_expln: bool = False,
        clip_mean: float = 2.0,
        features_extractor_class: Type[BaseFeaturesExtractor] = None, # CombinedExtractor,
        features_extractor_kwargs: Optional[Dict[str, Any]] = None,
        normalize_images: bool = True,
        optimizer_class: Type[th.optim.Optimizer] = th.optim.Adam,
        optimizer_kwargs: Optional[Dict[str, Any]] = None,
